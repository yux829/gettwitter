...
def main():
    ...
    while True:
        ...
        if event == '查询':
            ...
            if queryName :
                datas = gettwitter.getAndSaveAndShow(queryName,since,until,proxy)
                dataBuffer =''
                if datas:
